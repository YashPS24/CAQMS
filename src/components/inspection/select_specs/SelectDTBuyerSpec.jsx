...
const SelectDTBuyerSpec = () => {
  ...
  // Clear the page/reset state after successful save
  setSelectedSpecs([]);
  setOrderData(null);
  // Reset any other relevant state
  // You might also want to refresh data or navigate to a different page
  
  // Optional: Show additional success actions
  console.log("Template saved successfully, clearing page...");
};
